...
#[derive(Debug)]
pub struct ThriveRaftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ThriveRaftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ThriveRaft processing");
    
    let mut processor = ThriveRaftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ThriveRaftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ThriveRaftProcessor::new(false);
